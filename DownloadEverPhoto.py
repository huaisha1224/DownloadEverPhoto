...
async def main():
    ...
    if elm:
        ...
        get_download_url(access_token)
        time.sleep(10)



def get_download_url(access_token):
    """获取时光相册的下载url地址
    """
    ...
    headers = {
        ...
        "X-Uid": x_uid,
        "Cookie": f"_ga=GA1.2.277684100.1692952784; _gid=GA1.2.923114689.1692952784; access_token={access_token}; _gat=1; _ga_G6ZKBQ017P=GS1.2.1693036582.4.1.1693036582.0.0.0",
    ...
    if response.status_code == 200:
        ...
        download_EverPhoto(download_url, access_token)
    else:
